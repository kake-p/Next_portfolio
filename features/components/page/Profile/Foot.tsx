...
const Foot = () => {
  return (
    <footer className="flex justify-between items-start w-full p-6 relative black-bg">
      {/* 左側ナビゲーション */}
      <nav>
      ...
      {/* Back to Top ボタン */}
      <p className="absolute bottom-0 left-1/2 transform -translate-x-1/2 mb-2">
        <a href="#prof_head" className="text-xl font-bold hover:bg-black hover:opacity-70 p-2 block text-center">
          ↑<br />Back to Top
        </a>
      </p>
    </footer>
